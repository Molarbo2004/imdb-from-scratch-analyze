...
# GRIDSERACH для LOGISTICREGRESSION
...
print("\nClassification Report для Logistic Regression GridSearch:")
print(classification_report(y_test, y_pred))
...
models = {
    ...
    "GridRegression": grid.best_estimator_
}
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC-кривые GridSearchRegression и LogisticRegression')
plt.legend(loc="lower right")
